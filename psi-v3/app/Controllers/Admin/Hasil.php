    ...
    class Hasil extends BaseController
    {
        ...
        public function hasildasssemuapdf($start_dttm = null, $end_dttm = null) {
            ...
            foreach ($users as $u) {
                ...
                $ret = "<div style=\"text-align:center;\">DASS-42</div>
                        <hr>
                        <div>
                        <table border=\"0\">
                            <tbody>
                                ...
                                <table border=\"0\">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class=\"text-left text-bold\" width=\"150\">Catatan</td>
                                            <td class=\"text-center\" width=\"10\">:</td>
                                            <td class=\"text-left\">". ($notest[0]->no_antrian ?? '') ."</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class=\"table-responsive\">
                                ...
                                <thead>
                                    <tr>
                                        <th style=\"text-align:center;\" width=\"40%\"></th>
                                        <th style=\"text-align:center;\" width=\"20%\">Depression</th>
                                        <th style=\"text-align:center;\" width=\"20%\">Anxiety</th>
                                        <th style=\"text-align:center;\" width=\"20%\">Stress</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td style=\"padding-left:10px;justify-content:center;align-item:center;vertical-align: middle;\" width=\"40%\"> Normal</td>
                                    ...
                                    <tr>
                                        <td style=\"padding-left:10px;\"> Mild</td>
                                    ...
                                    <tr>
                                        <td style=\"padding-left:10px;\"> Moderate</td>
                                    ...
                                    <tr>
                                        <td style=\"padding-left:10px;\"> Severe</td>
                                    ...
                                    <tr>
                                        <td style=\"padding-left:10px;\"> Extremely Severe</td>
        ...
        public function hasilexcelpkp() {
            ...
            $sheet->setCellValue("D" . "1", "NRP/NIP");
            $sheet->setCellValue("E" . "1", "PANGKAT");
            $sheet->setCellValue("F" . "1", "SATKER");
            $sheet->setCellValue("G" . "1", "POLDA");
            $sheet->setCellValue("H" . "1", "JABATAN");
            ...
            foreach ($res as $val) {
                ...
                $sheetData->setCellValue("E" . $column, $val->pangkat);
        ...
        public function hasilAkhirExcelsrq29() {
            ...
            foreach ($res as $val) {
                ...
                $sheetData->setCellValue("G" . $column, !empty($depresi) ? implode(', ', $depresi) : 'NIHIL');
                $sheetData->setCellValue("H" . $column, !empty($napsa) ? implode(', ', $napsa) : 'NIHIL');
                $sheetData->setCellValue("I" . $column, !empty($kholik) ? implode(', ', $kholik) : 'NIHIL');
                $sheetData->setCellValue("J" . $column, !empty($ptsd) ? implode(', ', $ptsd) : 'NIHIL');
