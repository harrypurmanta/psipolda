...
class Latihanmodel extends Model
{
    ...
    public function updateResponPrev($soal_id,$jawaban_id,$group_id,$materi,$user_id,$session,$data,$used) {
        return $this->db->table('respon_latihan')
                        ->set($data)
                        ->where('soal_id',$soal_id)
                        ->where('group_id',$group_id)
    ...
    public function getKecerdasanSkor($user_id,$session,$materi,$used) {
        if ($session == "") {
            return $this->db->table('respon_latihan a')
                        ->select('*, a.pilihan_nm as pilihan_respon, a.no_soal as no_soal_respon,c.kunci as kunci_soal,b.jawaban_nm as jawaban_nmx')
    ...
    public function getKepribadianSkor($user_id,$session,$materi,$used) {
        if ($session == "") {
            return $this->db->table('respon_latihan a')
                        ->select('*, a.pilihan_nm as pilihan_respon, a.no_soal as no_soal_respon,c.kunci as kunci_soal,b.jawaban_nm as jawaban_nmx')
                        ->join('jawaban b','b.jawaban_id=a.jawaban_id','left')
