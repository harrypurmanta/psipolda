...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Users Pauli Kreplin</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url() ?>">Home</a></li>
              <li class="breadcrumb-item active">Users Pauli Kreplin</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <!-- <div class="row"> -->
                        <div class="row col-md-12" style="align-items: center;">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                  <button type="button" onclick="loadDataUserPauli()" class="btn btn-primary">Tampilkan</button>
                                </div>
                            </div>
                        </div>
                    <!-- </div> -->
              ...
              <div class="card-body">
                <table id="table_userpauli" class="table table-bordered table-hover">
                  <thead>
                  <tr>
...
<script>
  ...
  loadDataUserPauli = () => {
    ...
    let satuan = $("#satuan").val();
            $("#table_userpauli").DataTable({
                ajax: {
                    url: "/admin/hasil/getUserPauli",
                    type: "POST",
                    data: function(d) {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        className: "center",
                        render: function(data) {
                          return `<button class="btn btn-primary btn-sm" type="button" onclick="lihathasilpauli(${data.user_id})">Lihat Hasil</button>`
                        }
                    }
                ]
            })
        ...
        function lihathasilpauli(user_id) {
          let start_date = $("#start_dttm").val();
          let end_date = $("#end_dttm").val();
          
          window.open("<?= base_url() ?>/admin/hasil/hasilpauli/"+start_dttm.value+"/"+end_dttm.value+"/"+user_id,'_blank');
        }

        function unduhpauli(user_id) {
          window.open("<?= base_url() ?>/admin/hasil/hasilpaulipdf/"+start_dttm.value+"/"+end_dttm.value+"/"+user_id,'_blank');
        }
</script>
</body>
</html>