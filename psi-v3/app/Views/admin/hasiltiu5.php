        ...
        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="text-center"><h2>Tiu 5</h2></div>
                                            <hr>
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="text-center bg-green" width="20%">Benar</th>
                                                                <th class="text-center bg-red" width="20%">Salah</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
                                                                <td class="text-left text-bold bg-blue" style="padding-left:10px;">
                                                                    Tipe <?= $request->uri->getSegment(7) ?>
                                                                </td>
                                                                <td class="text-center text-bold" style="font-size: 20px;"><?= $benar ?></td>
                                                                <td class="text-center text-bold" style="font-size: 20px;"><?= $salah ?></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                        </div>
