                ...
                <div class="card-header">
                    <!-- <div class="row"> -->
                        <div class="row col-md-12" style="align-items: center;">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                  <button type="button" onclick="loadDataUserPapi()" class="btn btn-primary">Tampilkan</button>
                                </div>
                            </div>
                        </div>
                    <!-- </div> -->
...
<script>
  ...
  loadDataUserPapi = () => {
    ...
    let end_date = $("#end_dttm").val();
            $("#table_userdass").DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        className: "text-center",
                        render: function(data) {
                          return `<button class="btn btn-primary btn-sm" type="button" onclick="lihathasildass(${data.user_id})">Lihat Hasil</button>
                          <button class="btn btn-primary btn-sm" type="button" onclick="unduhdass(${data.user_id})"><i class="fa fa-download"> PDF</i></button>`
                        }
                    }
                ]
            })
        ...
        function lihathasildass(user_id) {
          let start_date = $("#start_dttm").val();
          let end_date = $("#end_dttm").val();
          window.open("<?= base_url() ?>/admin/hasil/hasilpapi/"+start_dttm.value+"/"+end_dttm.value+"/"+user_id,'_blank');
        }
        function unduhdass(user_id) {
          window.open("<?= base_url() ?>/admin/hasil/hasilpapipdf/"+user_id,'_blank');
        }
</script>
</body>
</html>