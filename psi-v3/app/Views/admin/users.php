...
<div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <button onclick="tambahuser()" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-lg"><i class="fa fa-plus"></i> Tambah</button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td><?= $key->person_nm ?></td>
                    <td style="text-align:center;"><?= $key->satuan_nm ?></td>
                    <td style="text-align:center;"><?= $key->birth_place ?>, <?= date("d F Y", strtotime($key->birth_dttm)); ?></td>
                    <td style="text-align:center;"><?= ($key->gender_cd == "m" ? "Laki-laki" : "Perempuan") ?></td>
                    ...
                    <td style="text-align: center;">
                        <?php
                            if ($this->session->user_group == "owner") {
                                echo "<button onclick='editperson(".$key->person_id.")' style='font-size:10px;' class='btn btn-secondary btn-sm' data-toggle='modal' data-target='#modal-lg'><i class='fa fa-pencil-alt'></i></button> 
                                  <button onclick='hapusperson(".$key->person_id .")' style='font-size:10px;' class='btn btn-danger btn-sm'><i class='fa fa-trash'></i></button> <br>
                                  <a href='".base_url() ."/admin/users/resetmateri/".$key->user_id ."' target='_blank' class='btn btn-warning btn-sm' style='margin-top: 5px;'>Reset</a> ";
                            }
                        ?>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2021 <a href="https://tespsikologipoldasumsel.com">Bagian Psikologi Polda Sumsel</a>.</strong> All rights reserved.
  </footer>
