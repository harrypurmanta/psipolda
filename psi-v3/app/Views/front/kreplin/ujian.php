...
<body class="hold-transition skin-blue layout-top-nav">
    ...
    function renderSoal(data) {
        ...
        let soal = data.data_soal.soal_nm.replace(/\s+/g,'').split('');
        soal.forEach(function(item){
            html += `
            <div style='display:inline-block;background-color:grey;
        ...
        html += `</div><div class='row col-md-12'><div style='text-align:center;'>`;
        ...
        data.data_soal.jawaban.forEach(function(j){
            ...
            class='btn btn-primary tombol_kreplin'>
                ${j.pilihan_nm}
            </button>`;
        });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.ret === "ok") {
                    ...
                    // Durasi waktu
                    let durasi = (data.sk_group_id == 1 || data.sk_group_id == 3) ? 30 : 20;
                    if (data.no_soal === 1) {
