...
<body class="hold-transition skin-blue layout-top-nav">
                ...
                <section class="content">
                    ...
                    <div class="row" style="margin-top:10px;">
                        <div class="col-md-12 text-center" style="display:flex;">
                            <div class="bg-gray col-md-12" style="border-radius:5px; margin: 0 auto;">
                            <label style="margin-top:10px;font-size:16px;" for="pertanyaan">Pertanyaan <span id="group_nm"></span> </label>
                                ...
                                <div class="row col-md-12" id="dv_main_jawaban" style="margin-top:10px;padding-bottom: 50px;">
                                    ...
                                    ?>
                                        <button class="btn btn-block btn-outline-success" style="text-align:left;font-size:18px;margin-top:20px;">
                                            <?= $key->pilihan_nm ?>. <?= $key->jawaban_nm ?>
                                        </button>
                                   
                                    <!-- <div class="col-md-12" id="dv_jawaban_<?= $key->jawaban_id ?>"
                                        onclick="selectJawaban(<?= $key->jawaban_id ?>,'<?= $key->pilihan_nm ?>')"
                                        class="col-md-12 jawaban_dv"
                                        style="margin-top:10px;margin-bottom:10px;background-color:#aeaebb;border-radius:5px;text-align: justify;">
                ...
                if (data.proc == "selesai") {
                    ...
                    Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                updateFinishRespon(materi, group_id);
                                window.location.href = "<?= base_url() ?>/papi/hasiltryout/" + materi + "/" +group_id;
                            }
                        });
    ...
    function updateFinishRespon(materi_id,group_id) {
        $.ajax({
            url: "<?= base_url('papi/updateFinishRespon') ?>",
            type: "post",
            dataType: "json",
            data: {
                "materi_id": materi_id,
